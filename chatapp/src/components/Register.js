...
const Register = () => {
    ...
    // git commit - m "Created a user route that handles logging user"
    ...
    const postDetails = (pics) => {
        ...
        if (pics.type === "image/png") {
            ...
            data.append("upload_preset", "apexChatApp");
            data.append("cloud_name", "ddetzhlhn");
            fetch("https://api.cloudinary.com/v1_1/ddetzhlhn/image/upload", {
                method: "post",
                body: data,
            })
                .then((res) => res.json())
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            localStorage.setItem("apexUser", JSON.stringify(data));
            setIsLoading(false);
            navigate("/chats");
        } catch (error) {
            toast.error(error);
        ...
        <VStack spacing="30px">
            ...
            <FormControl id="email" isRequired>
                ...
                <Input
                    ...
                    value={email}
                    size="md"
                    placeholder="eg. stephen@afexnigeria.com"
                />
            </FormControl>
